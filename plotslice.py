...
WARNING: This is a duplicate of plotslice.py provided with genetIC in the
tools subfolder. It's included here just for convenience. Don't edit this, even
to fix bugs! Instead, edit the 'official' version in genetIC and copy it over
to here.
